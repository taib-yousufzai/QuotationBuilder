...
import { FaArrowLeft, FaEdit, FaTrash, FaPrint, FaCalculator, FaMoneyBillWave, FaPercentage, FaFolder } from 'react-icons/fa'
...
function ViewQuotation() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const pass = prompt('Enter staff password to enable admin tools (leave blank for client view):')
      if (pass === 'admin123') {
        setStaffMode(true)
      }
    }, 100)
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div className="quote" id="viewQuotation" style={{ background: 'white', padding: '40px', borderRadius: '10px' }}>
        ...
        {/* Material Description - Hidden by default, can be enabled via section controls */}
        {false && (
