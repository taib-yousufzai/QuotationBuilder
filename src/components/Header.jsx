import { FaFileAlt, FaArrowsAltV, FaPalette, FaRupeeSign, FaUserShield, FaLink } from 'react-icons/fa'

function Header({ formData, setFormData, theme, setTheme, currency, setCurrency, pageSize, setPageSize, orientation, setOrientation, toggleStaffMode, staffMode }) {
      ...
      <div className="doc-meta">
        ...
        <div className="meta-group">
          <button className="btn-secondary" onClick={toggleStaffMode}>
            <FaUserShield /> {staffMode ? 'Client Mode' : 'Staff Mode'}
          </button>
